...
aws ec2 create-security-group \
    --group-name ogulcan_roman_numbers_converter_sec_grp \
...
aws ec2 run-instances \
    ...
    --key-name first-key \
    --security-groups ogulcan_roman_numbers_converter_sec_grp \
    --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=ogulcan_roman_numbers}]' \
...
aws ec2 describe-instances --filters "Name=tag:Name,Values=ogulcan_roman_numbers" --query 'Reservations[].Instances[].InstanceId[]'
```
